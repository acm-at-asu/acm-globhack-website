  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        {/* Hero Orb Logo */}
        <div className="relative mx-auto mb-8 w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80">
          ...
          <div className="relative w-full h-full float-animation">
            <Image
              ...
              fill
              className="object-contain liquid-sphere drop-shadow-[0_0_60px_rgba(59,130,246,0.5)]"
              priority
            />
          </div>
        </div>
        ...
        <div className="flex justify-center items-center gap-4 mb-8">
          <div className="glass-card glass-card-hover px-4 py-2 rounded-full flex items-center gap-2">
        ...
        <h1 className="text-6xl sm:text-8xl lg:text-9xl font-bold mb-4 tracking-tight">
          ...
          <span className="text-amber-400 text-glow-gold">HACK</span>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <div className="glass-card glass-card-hover px-5 py-3 rounded-2xl flex items-center gap-3 transition-all duration-300">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/sign-up">
            <Button 
              size="lg" 
              className="glass-button text-white text-lg px-10 py-7 rounded-2xl group"
            >
              Register Now
          ...
          <Link href="https://discord.gg/PA3XaxjxVH" target="_blank" rel="noopener noreferrer">
            <Button 
              size="lg" 
              variant="outline" 
              className="glass-card border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-500/50 text-lg px-10 py-7 rounded-2xl backdrop-blur-sm transition-all duration-300"
            >
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
          {[
            { value: "24", label: "Hours", color: "text-cyan-400" },
            { value: "150+", label: "Hackers", color: "text-amber-400" },
            { value: "8", label: "Tracks", color: "text-blue-400" },
            { value: "24/7", label: "Mentor Support", color: "text-pink-400" },
          ].map((stat, index) => (
            <div 
              key={index} 
              className="glass-card glass-card-hover rounded-2xl p-5 text-center shimmer"
            >
