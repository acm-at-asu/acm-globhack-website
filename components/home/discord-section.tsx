  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-panel rounded-3xl p-10 md:p-16 text-center border border-white/5">
          {/* Discord icon */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              ...
              <div 
                key={index} 
                className="glass-card rounded-2xl p-5 flex flex-col items-center gap-3 transition-all duration-300 hover:bg-white/[0.06]"
              >
          ...
          >
            <Button 
              size="lg" 
              className="bg-[#5865F2] hover:bg-[#4752C4] text-white text-lg px-10 py-7 rounded-2xl transition-all duration-300 hover:-translate-y-1"
            >
